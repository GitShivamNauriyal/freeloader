...
const MidHeading = () => {
    return (
        <div className="md:px-6 py-12 md:p-16 lg:pt-24 pb-8 bg-white  wavy-light-background">
            <motion.h1
                initial={{
                    opacity: 0,
                    y: 20,
                ...
                className="font-[AgrandirHeavy] px-6 md:px-20 lg:px-28 max-w-screen-xl mx-auto text-lg sm:text-xl lg:text-3xl text-left text-[#5e17eb] font-bold leading-5 md:leading-8 tracking-wide uppercase"
            >
